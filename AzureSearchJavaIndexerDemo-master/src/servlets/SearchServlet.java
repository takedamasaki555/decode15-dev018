...
public class SearchServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.setAttribute("search", SearchServiceHelper.getSearchURL(_properties, URLEncoder.encode(searchString, java.nio.charset.StandardCharsets.UTF_8.toString()).toString()));
	...
	private Properties loadConfigurations()
	{
		...
		try
		{
			properties.load(new FileInputStream("C:\\demo\\AzureSearchJavaIndexerDemo-master\\config.properties"));
			//properties.load(new FileInputStream("D:\\home\\site\\wwwroot\\webapps\\config.properties"));
		} catch (IOException e)
		{
			e.printStackTrace();
		}
